...
class Doctype_Validator
{
    ...
    */
    ...
    public function analyse($dtd)
    {
        ...
        /* 
        The root element that represents the document is the first element in the document. 
        The keywords PUBLIC and SYSTEM represent what kind of Document Type Definition it is.
        If it is PUBLIC, then this keyword is followed by a restricted form of "public identifier"
        called FPI (Formal Public Identifier) and If it is SYSTEM, only a system identifier must 
        be given. It states that the XML parser must locate the Document Type Definition (DTD) 
